...
from database import login_user, uploadImages, getimages, incScore, signup, getResult, modifyName, deleteImage, getImageByName
import base64
...
def uploading(id):
  ...
  if result == 'success':
    return redirect('/start', username=id)
